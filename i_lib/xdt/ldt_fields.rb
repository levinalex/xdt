...
section "8220" do
  ...
  has_field "0201", 1, 1, :required, "Betriebs- (BSNR) oder Nebenstellenbetriebsstättennummer (NBSNR)", :comment => "Gemeint ist hier der Einweiser; kann als Arztnummer/Arztident bei Nicht-Kassenärzten verwendet werden"
  has_field "0203", 1, 1, :required, "(N)BSNR-Bezeichnung"
  has_field "0212", 1, "n", :required, "Lebenslange Arztnummer (LANR)", :defaults => ["999999900", "888888800"]
  has_field "0211", 2, 1, :
  # has_field "0212", 1, 1,
end
